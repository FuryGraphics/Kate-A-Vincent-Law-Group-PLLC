/**
 * Miramar, FL Location Page — Kate A Vincent Law Group PLLC
 * URL: /miramar-fl
 */
...
const practiceCards = [
  { title: "Criminal Defense", description: "DUI, domestic violence, drug charges, and all criminal matters for Miramar residents.", href: "/criminal-defense", icon: <ScaleIcon size={32} /> },
  { title: "Personal Injury", description: "Car accidents, slip and fall, and serious injury claims for Miramar residents. No fee unless we win.", href: "/personal-injury", icon: <ShieldIcon size={32} /> },
  { title: "Family Law", description: "Divorce, child custody, and family law matters for Miramar families.", href: "/family-law", icon: <CourthouseIcon size={32} /> },
];

export default function MiramarFL() {
  return (
    <PageLayout
      title="Miramar FL Attorney | Kate A Vincent Law Group"
      description="Kate A Vincent Law Group PLLC — criminal defense, personal injury, and family law attorney serving Miramar, FL. Free consultation — (786) 709-3423."
    >
      <HeroSection
        h1="Miramar, FL Criminal, Injury & Family Law Attorney"
        subhead="Kate A Vincent Law Group PLLC serves clients throughout Miramar and Broward County. Call for a free consultation."
        backgroundImage="/manus-storage/hero-main_a33af5b3.jpg"
        breadcrumbs={[{ label: "Miramar, FL" }]}
        ctas={[
      ...
      <section className="py-20" style={{ background: "#0a0a0a" }}>
        <div className="container mx-auto px-4 lg:px-8" style={{ maxWidth: "1280px" }}>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div>
              <SectionHeader label="Serving Miramar" title="Legal Representation for Miramar Residents" />
              <Reveal>
                <p className="text-base mb-6" style={{ color: "#C8C0B0" }}>
                  Kate A Vincent Law Group PLLC serves clients throughout Miramar, FL. Our Hollywood office is conveniently located to serve Miramar residents facing criminal charges, personal injury claims, or family law matters.
                </p>
            ...
            <Reveal delay={0.1}>
              ...
              >
                <MapView
                  initialCenter={{ lat: 25.9867, lng: -80.2326 }}
                  initialZoom={13}
      ...
      <section className="py-20 section-navy">
        <div className="container mx-auto px-4 lg:px-8" style={{ maxWidth: "1280px" }}>
          <SectionHeader label="Legal Services" title="Practice Areas in Miramar, FL" />
          ...
          <Reveal>
            <div className="p-6 rounded-lg max-w-2xl" style={{ background: "#111827", border: "1px solid rgba(201,168,76,0.15)" }}>
              ...
              <p className="text-sm" style={{ color: "#9A9080" }}>
                Kate A Vincent Law Group PLLC regularly appears in Broward County courts on behalf of Miramar clients. We handle criminal, civil, and family law matters throughout the county court system.
              </p>
            </div>
          </Reveal>
        </div>
      ...
      <CTABand headline="Miramar resident facing a legal issue? Call Kate today." />
    </PageLayout>
  );
}
